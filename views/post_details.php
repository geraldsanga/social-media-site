                ...
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <?php
                            ...
                            $post_id = $_GET['post_id'];
                            $like_results = $mysqli->query("SELECT COUNT(pl.id) as number_of_likes, CASE WHEN pl.active = 1 THEN 1 ELSE 0 END AS user_like FROM PostLike as pl INNER JOIN User as u ON u.id=pl.user_id WHERE pl.post_id=$post_id") or die($mysqli->error);
                        ?>
                        <section class="mb-2">
                        <div class="mb-3">
                        <?php while($like_row = $like_results->fetch_assoc()):?>
                        <?php if($like_row["user_like"]):?>
                        <div class="row">
                            <div class="col-1">
                                <a href="javascript:void"><img src="../assets/icons/thumbs-up.svg" style="width:30px; height:30px; color:red;"></a>
                            </div>
                            <div class="col-1">
                                <a href="../controllers/unlike_post.php?post_id=<?php echo $post_row["id"]?>"><img src="../assets/icons/thumbs-down.svg" style="width:30px; height:30px; color:red;"></a>
                            </div>
                        </div>
                        <?php endif ?>
                        <?php if(!$like_row["user_like"]): ?>
                            <div class="row">
                            <div class="col-1">
                                <a href="../controllers/like_post.php?post_id=<?php echo $post_row["id"]?>"><img src="../assets/icons/thumbs-up.svg" style="width:30px; height:30px; color:red;"></a>
                            </div>
                            <div class="col-1">
                                <a href="javascript:void"><img src="../assets/icons/thumbs-down.svg" style="width:30px; height:30px; color:red;"></a>
                            </div>
                        </div>
                        <?php endif ?>
                        <?php endwhile ?>
